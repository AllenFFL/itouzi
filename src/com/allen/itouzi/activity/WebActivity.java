...
public class WebActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String[] webInfo = intent.getStringArrayExtra("webInfo");
		Url = ValueUtil.investWeb + webInfo[0] + "&invest_amount=" + webInfo[1];
//
//		Log.i(WebActivity.class.getName(), "id:" + webInfo[0] + "  uRL is --"
//				+ Url);
		...
		//UMENG
		new MobclickAgentJSInterface(this, web_view);
		...
		String URL = ValueUtil.investServer + ValueUtil.investToken
				+ FileUtil.getToken(getApplicationContext()) + "&url="
				+ Uri.encode(Url);
		...
		web_view.setWebViewClient(new WebViewClient() {
			...
			public void onPageStarted(WebView view, String url, Bitmap favicon) {
				if (progDlg == null) {
					progDlg = new ProgressDialog(WebActivity.this);
